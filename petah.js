		...
		//SETTINGS
			...
			function naughtyWordToggle(){
				if(document.getElementById('swearToggle').innerHTML=='Censor'){
					...
					document.getElementById('swearToggle').style='padding:5px;black;color:white;border-radius:7px;';
					...
					document.getElementById('swearToggle').style='padding:5px;white;color:black;border-radius:7px;';
				}else{
