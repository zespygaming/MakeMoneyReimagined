		...
		//SETTINGS
			...
			function naughtyWordToggle(){
				if(document.getElementById('swearToggle').innerHTML=='Censor'){
					document.getElementById('swearInstance1').innerHTML='u s';
					...
					document.getElementById('swearInstance1').innerHTML='u fucking s';
					...
					document.getElementById('swearInstance1').innerHTML='u f***king s';
